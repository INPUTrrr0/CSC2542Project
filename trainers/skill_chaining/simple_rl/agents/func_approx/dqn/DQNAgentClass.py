...
from simple_rl.agents.func_approx.intra_dqn.utils import compute_gradient_norm
...
class QNetwork(nn.Module):
    ...
    def initialize_with_bigger_network(self, bigger_net):
        ...
        assert self.fc3.out_features == 5, "Expected LunarLander with 4 actions, not {} ".format(self.fc3.out_features)
